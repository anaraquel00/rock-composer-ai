TEMAS_DETALHADOS = {
    "Metal/Power Metal": {
        "nucleos": [ "Cavaleiro das estrelas", "Dragão de ébano", "Espada ancestral", "Profecia celestial" ],
        "acoes":   [ "ergue o lábaro", "cruza o horizonte", "desafia o crepúsculo", "convoca os eleitos" ],
        "elementos": [ "sob a lua rubra", "entre relâmpagos cósmicos", "no altar dos deuses antigos","pelas veredas do destino" ]
    },
    "Punk/Hardcore": {
        "nucleos": ["rebelião urbana", "gritos de liberdade","ruas em chamas", "sombras da opressão"],
        "acoes": ["grita contra a injustiça","desafia o sistema","rompe as correntes","constrói um novo amanhã", "rompe as barreiras"],
        "elementos": ["sistema opressor", "corrupção governamental", "luta pela verdade","opressão social", "futuro incerto", "solidão na multidão" ]
    },
    "Shoegaze": {
